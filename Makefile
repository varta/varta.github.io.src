...
DEPLOYREPOSITORY=varta.github.io
...
deploy: publish
	...
	else cd _build && git clone git@github.com:varta/$(DEPLOYREPOSITORY).git; \
	fi
...
.PHONY: html help clean regenerate serve devserver publish ssh_upload rsync_upload ftp_upload github
